...
class HotelServiceType(models.Model):
    ...
    service_id = fields.Many2one("hotel.service.type", "Service Category", ondelete="restrict",)
    child_ids = fields.One2many(
        "hotel.service.type", "service_id", "Service Child Categories", ondelete="restrict",
    )
